...
namespace AppCitas.UnitTests.Tests
{
    public class UsersControllerTests
    {
        ...
        [Theory]
        [InlineData("OK", "esmeralda", "Pa$$w0rd",1,10)]
        ...
        [Theory]
        [InlineData("NoContent", "caroline", "Pa$$w0rd","IntroductionU","LookingForU","InterestsU","CityU","CountryU")]
        ...
        [Theory]
        [InlineData("Created", "hewitt", "Pa$$w0rd", "../../../Imagen1.jpg")]
        ...
        [Theory]
        [InlineData("NoContent", "esmeralda", "Pa$$w0rd", "../../../Imagen2.jpg")]
        ...
        [Theory]
        [InlineData("OK", "lisa", "Pa$$w0rd","../../../Imagen3.jpg")]
        ...
        [Theory]
        [InlineData("NotFound", "hewitt", "Pa$$w0rd", "27")]
