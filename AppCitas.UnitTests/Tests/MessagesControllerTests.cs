...
namespace AppCitas.UnitTests.Tests
{
    public class MessagesControllerTests
    {
        ...
        [Theory]
        [InlineData("BadRequest", "louise", "Pa$$w0rd", "louise","MEXICO PASA AL 5TO PARTIDO")]
        ...
        [Theory]
        [InlineData("NotFound", "hewitt", "Pa$$w0rd", "canelo", "Messi")]
        ...
        [Theory]
        [InlineData("OK", "tanner", "Pa$$w0rd", "rosa", "Cariñosas")]
        ...
        [Theory]
        [InlineData("OK", "louise", "Pa$$w0rd", "rosa")]
        ...
        [Theory]
        [InlineData("OK", "berry", "Pa$$w0rd", "lisa", "Gavi rey de españa")]
        ...
        [Theory]
        [InlineData("Unauthorized", "hewitt", "Pa$$w0rd", "caroline", "Hola", "esmeralda")]
